      ...
      <div style={{ marginTop: "80px" }}>
        ...
        >
          ...
          >
            ...
            >
              <Avatar
                alt={`${logginedUser.username}'s Avatar`}
                src={avatar}
                style={{
                  width: "70px",
                  height: "70px",
              ...
              <Typography variant="h2" color="primary">
                {logginedUserInfo.username}
              </Typography>
              <Typography variant="body2" color="primary">
                {logginedUserInfo.email}
              </Typography>
            </Grid>
          </Grid>
          <Grid
          ...
          >
            ...
            >
              ...
              >
                {" "}
                {logginedUserInfo.followings === ""
                  ? 0
                  : logginedUserInfo.followings.split(",").length}{" "}
              </Typography>
            </Grid>
            <Grid
              item
            ...
            >
              ...
              >
                {logginedUserInfo.fans === ""
                  ? 0
                  : logginedUserInfo.fans.split(",").length}{" "}
              </Typography>
            </Grid>
            <Grid
              item
        ...
        <DialogComponent
          ...
          children={
            <UserList
              titleText={"You are following:"}
              setCardOpen={setfollowingCard}
              userList={followingsList}
        ...
        <DialogComponent
          ...
          children={
            <UserList
              titleText={"Your followers:"}
              setCardOpen={setfansCard}
              userList={fansList}
              logginedUser={logginedUser}
            />
          }
